...
# 下载应用代码
echo "下载应用代码..."
curl -fsSL https://github.com/user/repository/archive/refs/heads/main.zip -o app.zip
unzip app.zip -d /opt/vps-monitor
cd /opt/vps-monitor/repository-main
...
# 配置 Nginx
echo "配置 Nginx..."
sudo cp /opt/vps-monitor/repository-main/nginx/vps-monitor.conf /etc/nginx/sites-available/vps-monitor
...
[Service]
ExecStart=/opt/vps-monitor/venv/bin/python3 /opt/vps-monitor/repository-main/app.py
WorkingDirectory=/opt/vps-monitor/repository-main
Restart=always
